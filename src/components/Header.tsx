...
function Header() {
  ...
  return (
    <header className="header">
      <div className='header-mobile-logo-menu'>
        <img src={Logo} alt="header-logo" className="header-logo-mobile" onClick={() => navigate('/')} />
      ...
      <div className={`header-sections ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="header-content">
          <nav className={`header-nav ${mobileMenuOpen ? 'mobile-show' : ''}`}>
     ...
     <div className='header-bottom'>
      <nav className='header-bottom-nav'>
        ...
        <NavLink to="/occasion" className="header-bottom-link">Повод</NavLink>
