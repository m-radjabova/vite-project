...
function CarouselProduct() {
    ...
    useEffect(() => {
        const mockData: CarouselImg[] = [
            { id: 1, image: "https://i.imgur.com/YjQ5JYj.jpg", title: "Strawberry Dream", flavor: "berry" },
            { id: 2, image: "https://i.imgur.com/K3W5JYj.jpg", title: "Chocolate Heaven", flavor: "chocolate" },
            { id: 3, image: "https://i.imgur.com/L2W5JYj.jpg", title: "Vanilla Cloud", flavor: "vanilla" },
            { id: 4, image: "https://i.imgur.com/M2W5JYj.jpg", title: "Mint Magic", flavor: "mint" },
            { id: 5, image: "https://i.imgur.com/N2W5JYj.jpg", title: "Caramel Swirl", flavor: "caramel" },
            { id: 6, image: "https://i.imgur.com/O2W5JYj.jpg", title: "Rainbow Bliss", flavor: "rainbow" },
            { id: 7, image: "https://i.imgur.com/P2W5JYj.jpg", title: "Berry Mix", flavor: "berry" },
            { id: 8, image: "https://i.imgur.com/Q2W5JYj.jpg", title: "Cookies & Cream", flavor: "cookie" },
        ];
        
        try {
            apiClient.get<CarouselImg[]>("/carouselImg").then((res) => {
                setCarouselImg(res.data.length > 0 ? res.data : mockData);
            });
        } catch {
            setCarouselImg(mockData);
        }
    }, []);
    ...
    const SlideImage = styled("img")(({ theme }) => ({
        ...
        "&:hover": {
            ...
            boxShadow: "0 12px 40px rgba(255, 105, 180, 0.6)",
            borderColor: "#FFD1DC",
            zIndex: 10,
        },
    ...
    const getFlavorIcon = (flavor?: string) => {
        const icons: Record<string, JSX.Element> = {
            chocolate: <GiChocolateBar style={{ color: "#7B3F00", fontSize: "1.6rem" }} />,
            berry: <GiStrawberry style={{ color: "#FF1493", fontSize: "1.6rem" }} />,
            vanilla: <FaIceCream style={{ color: "#F8EDE5", fontSize: "1.4rem" }} />,
            mint: <GiIcePop style={{ color: "#98FF98", fontSize: "1.6rem" }} />,
            caramel: <FaCookieBite style={{ color: "#D27D46", fontSize: "1.4rem" }} />,
            rainbow: <RiRainbowLine style={{ fontSize: "1.6rem" }} />,
            cookie: <FaCookieBite style={{ color: "#D2B48C", fontSize: "1.4rem" }} />,
            default: <IoIosIceCream style={{ color: "#FF69B4", fontSize: "1.6rem" }} />
        };
