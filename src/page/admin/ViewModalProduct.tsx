                ...
                >
                  ...
                  >
                    ...
                    <Box display="flex" gap={3}>
                      ...
                      />
                      <Box flex={1}>
                        <Typography variant="body1" mb={1}  color="text.secondary" sx={{display: '-webkit-box', WebkitLineClamp: 3, overflow: 'hidden', WebkitBoxOrient: 'vertical', textOverflow: 'ellipsis'}}>
